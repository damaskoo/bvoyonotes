...
import com.grable.notebvoyo.adapter.NotesAdapter;
import com.grable.notebvoyo.database.NotesDataBase;
import com.grable.notebvoyo.listeners.NotesListener;
...
public class MainActivity extends AppCompatActivity implements NotesListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageAddNoteMain.setOnClickListener(v -> startActivityForResult(new Intent(getApplicationContext(),
